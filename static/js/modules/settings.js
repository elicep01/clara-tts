...
export class SettingsManager {
    ...
    async loadLLMStatus() {
        ...
        downloadedList.innerHTML = '<div class="llm-loading"><div class="spinner"></div></div>';
        availableList.innerHTML = '<div class="llm-loading"><div class="spinner"></div></div>';
        ...
        try {
            ...
            downloadedList.innerHTML = '<div class="llm-empty">Failed to load models</div>';
            availableList.innerHTML = '<div class="llm-empty">Failed to load models</div>';
        }
    }
